...
let arr = [];
class Vihecles {
    constructor(brand, model, yearOfProduction, fuelType, image) {
        this.brand = brand;
        this.model = model;
...
class Cars extends Vihecles {
    constructor(brand, model, yearOfProduction, fuelType, image, numberOfSeats, color) {
...
class Motorbikes extends Vihecles {
    constructor(brand, model, yearOfProduction, fuelType, image, engineType, boreXstroke, maxHorsepower) {
        super(brand, model, yearOfProduction, fuelType, image);
...
console.log(arr);
let printCard = document.getElementById("printCard");
